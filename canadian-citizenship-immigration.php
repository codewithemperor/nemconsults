...
<html lang="en">
    ...
    <!-- Head -->
    <?php
    $pageTitle = "Nemconsults - Canadian Citizenship Immigration";
            ...
            <div class="container my-3 px-4 px-lg-0">
                ...
                <div class="col-lg-6 p-3 p-lg-5 pt-lg-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
                        <a href="apply.php" class="btn btn-accent p-2 px-5" data-aos="zoom-in-up" data-aos-duration="500" data-aos-delay="300">Book Now!</a>
                    </div>
                </div>
