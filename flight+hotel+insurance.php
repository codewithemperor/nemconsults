...
<html lang="en">
    ...
    $pageTitle = "Nemconsults - Fligt Itinerary, Hotel Reservation & Insurance";
                ...
                <div class="container my-3 px-4 px-lg-0">
                    ...
                    <div class="my-5 bg-body-secondary">
                        <div class="p-3 py-5 p-md-5 d-flex flex-column justify-content-center align-items-center text-center">
                            ...
                            <div class="">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="insuranceRadio" id="insuranceRadio" value="yes" checked>
                                    <label class="form-check-label fw-semibold" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="insuranceRadio" id="insuranceRadio" value="no">
