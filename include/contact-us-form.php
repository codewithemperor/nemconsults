...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO contact (first_name, surname, phone_number, email, message, sent_date) 
        VALUES (?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssss", $firstName, $surname, $phoneNumber, $email, $message, $sentDate);
